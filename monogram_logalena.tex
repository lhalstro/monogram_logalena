...
\usepackage{freetikz}
\usepackage{xcolor}
% \definecolor{lupine}{rgb}{152,137,205}
\definecolor{lupine}{rgb}{0.60,0.54,0.80}
\begin{document}
\begin{tikzpicture}
...
%---------------------------------------------------------
%
%SET COLOR OF MONOGRAM
\newcommand\monogramcolor{black}
% \newcommand\monogramcolor{lupine}
% SET THICKNESS OF MONOGRAM
% \newcommand\thicc{6mm} %bolder
\newcommand\thicc{5mm} %bold
% \newcommand\thicc{3mm} %thin
%
\draw[line width=\thicc, line cap=round, line join=round, draw=\monogramcolor]
% (-0.75, 6.5) to[out=0, in=180]
